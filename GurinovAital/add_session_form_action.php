...
INSERT INTO Datacard (idCard, Patient, Session, Conclusion) VALUES ((SELECT IFNULL(max(idCard)+1,1) 
from (Select idCard from Datacard) as id),$pat,(SELECT IFNULL(max(idSession)+1,1) from (Select idSession from Session) as kd),2);";
